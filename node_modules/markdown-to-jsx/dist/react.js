import*as a0 from"react";var I=32,R=9,q9=13,T=10,Q0=96,b0=126,z0=91,r0=94,p=62,J9=35,e$=36,p9=37,d=45,h0=61,_0=92,D0=42,B0=95,X0=60,d9=64,m0=93,g0=33,F$=38,x0=58,y$=70,b9=102,c9=104,P9=119,q$=116,L$=112,$6=115,Z6=160,Q6=12,k$=44,W$=59,S9=63,s0=46,A0=47,O9=39,W9=34,H9=43,R0=124,D9=123,$$=125,t0=40,e0=41,l9=30,S$=31,e=48,$0=57,r=65,s=90,U0=97,j0=122,E9=128,X9=32,UZ={blockQuote:0,breakLine:1,breakThematic:2,codeBlock:3,codeInline:4,footnote:5,footnoteReference:6,frontmatter:7,gfmTask:8,heading:9,htmlBlock:10,htmlComment:11,htmlSelfClosing:12,image:13,link:14,orderedList:15,paragraph:16,ref:17,refCollection:18,table:19,text:20,textFormatted:21,unorderedList:22},A=UZ;import{decodeEntity as OZ}from"markdown-to-jsx/entities";function F6($){if(!Y6($,"---"))return null;let Q=3;for(;Q<$.length&&($[Q]===" "||$[Q]==="	");)Q++;if(Q<$.length&&$[Q]==="\r"&&Q++,Q>=$.length||$[Q]!==`
`)return null;Q++;let Z=!1;for(;Q<$.length;){let V=Q;for(;Q<$.length&&$[Q]!==`
`&&$[Q]!=="\r";)Q++;if(Q>=$.length)break;let Y=Q;if($[Q]==="\r"&&Q++,Q<$.length&&$[Q]===`
`&&Q++,Y6($,"---",V))return{endPos:Q,hasValidYaml:Z};let J=$.indexOf(":",V);J!==-1&&J<Y&&(Z=!0)}return null}var HZ=/&([a-zA-Z0-9]+|#[0-9]{1,7}|#x[0-9a-fA-F]{1,6});/gi,DZ={class:"className",for:"htmlFor",allowfullscreen:"allowFullScreen",allowtransparency:"allowTransparency",autocomplete:"autoComplete",autofocus:"autoFocus",autoplay:"autoPlay",cellpadding:"cellPadding",cellspacing:"cellSpacing",charset:"charSet",classid:"classId",colspan:"colSpan",contenteditable:"contentEditable",contextmenu:"contextMenu",crossorigin:"crossOrigin",enctype:"encType",formaction:"formAction",formenctype:"formEncType",formmethod:"formMethod",formnovalidate:"formNoValidate",formtarget:"formTarget",frameborder:"frameBorder",hreflang:"hrefLang",inputmode:"inputMode",keyparams:"keyParams",keytype:"keyType",marginheight:"marginHeight",marginwidth:"marginWidth",maxlength:"maxLength",mediagroup:"mediaGroup",minlength:"minLength",novalidate:"noValidate",radiogroup:"radioGroup",readonly:"readOnly",rowspan:"rowSpan",spellcheck:"spellCheck",srcdoc:"srcDoc",srclang:"srcLang",srcset:"srcSet",tabindex:"tabIndex",usemap:"useMap",viewbox:"viewBox"};function i0($){var Q={};for(var Z in $){var V=Z.toLowerCase(),Y=DZ[V];if(Y)Q[Y]=$[Z];else{var J=Z.indexOf(":");J!==-1?Q[Z.slice(0,J)+Z[J+1].toUpperCase()+Z.slice(J+2)]=$[Z]:Q[Z]=$[Z]}}return Q}var q6=/(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s|^<(div|p|h[1-6]|ul|ol|li|blockquote|pre|table|thead|tbody|tr|td|th|dl|dt|dd|hr|address|article|aside|details|dialog|figure|figcaption|footer|form|header|main|menu|nav|section|summary|textarea|fieldset|legend|center|dir|hgroup|marquee|search|output|template)\b)/i;function o9($){return $.indexOf("&")===-1?$:$.replace(HZ,(Q,Z)=>{var V=OZ(Z);if(V)return V;if(Z[0]==="#"){var Y=Z[1]==="x"||Z[1]==="X"?parseInt(Z.slice(2),16):parseInt(Z.slice(1),10);return Y===0||Y>=55296&&Y<=57343||Y>1114111?"\uFFFD":Y<=65535?String.fromCharCode(Y):String.fromCharCode(55296+(Y-65536>>10),56320+(Y-65536&1023))}return Q})}var V6=/(javascript|vbscript|data(?!:image)):/i;function x9($){if(V6.test($))return null;if($.indexOf("%")===-1)return $;try{let Q=decodeURIComponent($).replace(/[^A-Za-z0-9/:]/g,"");if(V6.test(Q))return null}catch{return null}return $}var T0={},C0,y0;for(C0=[192,193,194,195,196,197,224,225,226,227,228,229,230,198],y0=0;y0<C0.length;y0++)T0[C0[y0]]="a";for(T0[231]=T0[199]="c",T0[240]=T0[208]="d",C0=[200,201,202,203,233,232,234,235],y0=0;y0<C0.length;y0++)T0[C0[y0]]="e";for(C0=[207,239,206,238,205,237,204,236],y0=0;y0<C0.length;y0++)T0[C0[y0]]="i";for(T0[209]=T0[241]="n",C0=[248,216,339,338,213,245,212,244,211,243,210,242],y0=0;y0<C0.length;y0++)T0[C0[y0]]="o";for(C0=[220,252,219,251,218,250,217,249],y0=0;y0<C0.length;y0++)T0[C0[y0]]="u";T0[376]=T0[255]=T0[221]=T0[253]="y";function BZ($){return $<E9&&(_Z[$]&(g$|W6))!==0}function u0($){for(var Q="",Z=-1,V=0;V<$.length;V++){var Y=$.charCodeAt(V);if(BZ(Y))Y>=r&&Y<=s?(Z>=0&&(Q+=$.slice(Z,V),Z=-1),Q+=String.fromCharCode(Y+X9)):Z<0&&(Z=V);else if(Y===I||Y===d)Z>=0&&(Q+=$.slice(Z,V),Z=-1),Q+="-";else{Z>=0&&(Q+=$.slice(Z,V),Z=-1);var J=T0[Y];J&&(Q+=J)}}return Z>=0&&(Q+=$.slice(Z)),Q}function Y6($,Q,Z){return $.startsWith(Q,Z)}var J6=new Set(["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr","circle","ellipse","line","path","polygon","polyline","rect","use","stop","animate","set"]);function f9($){let Q=$.toLowerCase();if(J6.has(Q))return!0;let Z=Q.indexOf(":");return Z!==-1?(Q=Q.slice(Z+1),J6.has(Q)):!1}var Z$=1,z$=2,g$=4,W6=8,X6=16,K6=32,jZ=64,G6=1,MZ=2,AZ=3,vZ=4,_Z=(function(){let $=new Uint8Array(128),Q;for($[R]=Z$|K6,$[T]=Z$|X6,$[Q6]=Z$,$[q9]=Z$|X6,$[I]=Z$|K6,Q=g0;Q<=A0;Q++)$[Q]=z$;for(Q=x0;Q<=d9;Q++)$[Q]=z$;for(Q=z0;Q<=Q0;Q++)$[Q]=z$;for(Q=D9;Q<=b0;Q++)$[Q]=z$;for(Q=e;Q<=$0;Q++)$[Q]=W6;for(Q=r;Q<=s;Q++)$[Q]=g$|jZ;for(Q=U0;Q<=j0;Q++)$[Q]=g$;return $})(),X5=(function(){let $=new Uint8Array(128);return $[_0]=MZ,$[z0]=vZ,$[D0]=$[B0]=$[b0]=$[h0]=AZ,$[Q0]=$[X0]=$[d9]=$[m0]=$[T]=$[I]=$[g0]=G6,$[b9]=$[c9]=$[P9]=G6,$})(),g9=[];function x$($){var Q=$.indexOf("\r"),Z=$.indexOf("\0");if(Q===-1&&Z===-1)return $;var V=$.length;g9.length=0;var Y=0,J=0;for(Q===-1?J=Z:Z===-1?J=Q:J=Q<Z?Q:Z;J<V;J++){var X=$.charCodeAt(J);X===q9?(Y<J&&g9.push($.slice(Y,J)),J+1<V&&$.charCodeAt(J+1)===T&&J++,g9.push(`
`),Y=J+1):X===0&&(Y<J&&g9.push($.slice(Y,J)),g9.push("\uFFFD"),Y=J+1)}return Y<V&&g9.push($.slice(Y)),g9.join("")}function K5($){if(!$)return!1;for(var Q in $)return!0;return!1}function r9($,Q,Z){for(var V=$,Y=Q.split("."),J=0;J<Y.length&&(V=V?.[Y[J]],V!==void 0);)J++;return V||Z}function z6($){for(var Q=!1,Z=0;Z<$.length;Z++){var V=$.charCodeAt(Z);if(V<=I||V===W9||V===p9||V===X0||V===p||V===z0||V===_0||V===m0||V===r0||V===Q0||V>=123){Q=!0;break}}if(!Q)return $;for(var Y="",Z=0;Z<$.length;Z++){var V=$.charCodeAt(Z);if(V===p9&&Z+2<$.length){var J=$.charCodeAt(Z+1),X=$.charCodeAt(Z+2);if((J>=e&&J<=$0||J>=r&&J<=y$||J>=U0&&J<=b9)&&(X>=e&&X<=$0||X>=r&&X<=y$||X>=U0&&X<=b9)){Y+=$[Z]+$[Z+1]+$[Z+2],Z+=2;continue}}Y+=encodeURI($[Z])}return Y}function U6(...$){return $.filter(Boolean).join(" ")}function G5($,Q){if(!Q)return $;let Z=r9(Q,$,void 0);return typeof Z=="string"?Z:typeof Z=="object"&&Z.component?Z.component:$}function F5($,Q){if(!Q)return{};let Z=r9(Q,$,void 0);return typeof Z=="object"&&Z.props?Z.props:{}}var NZ=new Set(["title","textarea","style","xmp","iframe","noembed","noframes","script","plaintext"]),U$=/<(\/?)(title|textarea|style|xmp|iframe|noembed|noframes|script|plaintext)(\s|>|\/)/gi;function f$($){return NZ.has($.toLowerCase())}function O6($){return U$.lastIndex=0,U$.test($)}function T$($){return U$.lastIndex=0,$.replace(U$,function(Q,Z,V,Y){return"&lt;"+Z+V+Y})}var b6=/^<([a-zA-Z][a-zA-Z0-9-]*)\s[^>]*>/,P6=/^<[A-Z]/,h$=["script","pre","style","textarea"],V$=new Set(h$),IZ=/<(?:pre|script|style|textarea)\b/i,bZ=new Set(["table","thead","tbody","tfoot","tr","td","th"]),w6=new Uint8Array(128);(function(){for(var $=[Q0,D0,B0,b0,h0,z0,g0,X0,_0,S$,c9,P9,b9],Q=0;Q<$.length;Q++)w6[$[Q]]=1})();var D6=/([a-zA-Z_][a-zA-Z0-9_-]*)=(?:"([^"]*)"|'([^']*)')/g;function R6($){return V$.has($)}function y6($){return IZ.test($)}function L6($,Q,Z){for(var V=Q,Y=Z;V<Y&&($.charCodeAt(V)===I||$.charCodeAt(V)===R);)V++;if(V>=Y)return!1;$.charCodeAt(V)===R0&&V++;for(var J=0;V<Y;){for(;V<Y&&($.charCodeAt(V)===I||$.charCodeAt(V)===R);)V++;if(V>=Y)break;if($.charCodeAt(V)===R0&&J>0){for(var X=V+1;X<Y&&($.charCodeAt(X)===I||$.charCodeAt(X)===R);)X++;if(X>=Y)return!0}if($.charCodeAt(V)===x0&&V++,V>=Y||$.charCodeAt(V)!==d)return!1;for(;V<Y&&$.charCodeAt(V)===d;)V++;for(V<Y&&$.charCodeAt(V)===x0&&V++,J++;V<Y&&($.charCodeAt(V)===I||$.charCodeAt(V)===R);)V++;if(V<Y)if($.charCodeAt(V)===R0)V++;else return!1}return J>0}function j9($,Q){if($.charCodeAt(Q)!==X0)return null;let Z=Q+1,V=$.length,Y=!1;$.charCodeAt(Z)===A0&&(Z++,Y=!0);let J=Z,X=$.charCodeAt(Z);if(!(X>=U0&&X<=j0||X>=r&&X<=s))return null;for(;Z<V&&($.charCodeAt(Z)>=U0&&$.charCodeAt(Z)<=j0||$.charCodeAt(Z)>=r&&$.charCodeAt(Z)<=s||$.charCodeAt(Z)>=e&&$.charCodeAt(Z)<=$0||$.charCodeAt(Z)===d);)Z++;let K=$.slice(J,Z);if(!K)return null;let G=Z;for(;Z<V&&($.charCodeAt(Z)===I||$.charCodeAt(Z)===R||$.charCodeAt(Z)===T);)Z++;let F=$.slice(G,Z);if(Z===G&&Z<V){var W=$.charCodeAt(Z);if(W!==p&&W!==A0)return null}let z=Z,H={},O=!1;for(;Z<V;){let L=$.charCodeAt(Z);if(L===p){let k=$.slice(z,Z);return{tag:K,attrs:H,selfClosing:!1,end:Z+1,rawAttrs:k,whitespaceBeforeAttrs:F,isClosing:Y,hasSpaceBeforeSlash:O}}if(L===I||L===R||L===T){Z++;continue}if(L===A0&&Z+1<V&&$.charCodeAt(Z+1)===p){let k=$.slice(z,Z);return O=Z>z&&$.charCodeAt(Z-1)===I,{tag:K,attrs:H,selfClosing:!0,end:Z+2,rawAttrs:k,whitespaceBeforeAttrs:F,isClosing:Y,hasSpaceBeforeSlash:O}}var D=Z,q=$.charCodeAt(Z);if(!(q>=U0&&q<=j0||q>=r&&q<=s||q===B0||q===x0))return null;for(Z++;Z<V;){var U=$.charCodeAt(Z);if(U>=U0&&U<=j0||U>=r&&U<=s||U>=e&&U<=$0||U===B0||U===s0||U===x0||U===d)Z++;else break}for(var B=$.slice(D,Z);Z<V&&($.charCodeAt(Z)===I||$.charCodeAt(Z)===R);)Z++;if($.charCodeAt(Z)!==h0){H[B]="";continue}for(Z++;Z<V&&($.charCodeAt(Z)===I||$.charCodeAt(Z)===R);)Z++;var j=$.charCodeAt(Z);if(j===W9||j===O9){Z++;for(var v=Z;Z<V&&$.charCodeAt(Z)!==j;)Z++;if(Z>=V)return null;if(H[B]=$.slice(v,Z),Z++,Z<V){var y=$.charCodeAt(Z);if(y!==I&&y!==R&&y!==T&&y!==p&&y!==A0)return null}}else if(j===D9){var N=1,v=Z;for(Z++;Z<V&&N>0;){var U=$.charCodeAt(Z);U===D9?N++:U===$$&&N--,Z++}H[B]=$.slice(v,Z)}else{for(var v=Z;Z<V;){var M=$.charCodeAt(Z);if(M===I||M===R||M===p||M===T||M===W9||M===O9||M===h0||M===X0||M===Q0)break;Z++}if(Z===v)return null;H[B]=$.slice(v,Z)}}return null}function j$($,Q,Z){for(var V=0,Y=$.length,J=!1;V<Y;){for(var X=$.indexOf(`
`,V),K=X<0?Y:X,G=V,F=0;G<K&&F<4;)if($.charCodeAt(G)===I)F++,G++;else if($.charCodeAt(G)===R)F+=4,G++;else break;if(G>=K){J=!1,V=X<0?Y:X+1;continue}if(F<4){var W=$.charCodeAt(G);if(W===Q0||W===b0){for(var z=W,H=0,O=G;O<K&&$.charCodeAt(O)===z;)H++,O++;if(H>=3){J=!1;for(var D=X<0?Y:X+1;D<Y;){for(var q=D,U=0;q<Y&&U<4;){var B=$.charCodeAt(q);if(B===I)U++,q++;else if(B===R)U+=4,q++;else break}if(U<4&&q<Y&&$.charCodeAt(q)===z){for(var j=0;q<Y&&$.charCodeAt(q)===z;)j++,q++;if(j>=H){for(;q<Y&&($.charCodeAt(q)===I||$.charCodeAt(q)===R);)q++;if(q>=Y||$.charCodeAt(q)===T){V=q>=Y?Y:q+1;break}}}for(;D<Y&&$.charCodeAt(D)!==T;)D++;D<Y&&D++}D>=Y&&(V=Y);continue}}}for(var v=G;v<K&&$.charCodeAt(v)===p;){v++,v<K&&$.charCodeAt(v)===I&&v++;for(var y=0;v<K&&y<4;)if($.charCodeAt(v)===I)y++,v++;else if($.charCodeAt(v)===R)y+=4,v++;else break;if(y>=4)break;J=!1}if(!J&&F<4&&v<K&&$.charCodeAt(v)===z0&&!(v+1<Y&&$.charCodeAt(v+1)===r0)){var N=k6($,v,Q);if(N){V=N,J=!1;continue}}var M=$.charCodeAt(G);if(M===J9&&F<4)J=!1;else if(F<4&&(M===d||M===D0||M===B0)){for(var L=G,k=0;L<K;){var b=$.charCodeAt(L);if(b===M)k++;else if(b!==I&&b!==R)break;L++}J=!(k>=3&&L>=K)}else J=!0;V=X<0?Y:X+1}}function k6($,Q,Z){let V=$.length;if($.charCodeAt(Q)!==z0)return null;let Y=Q+1<V&&$.charCodeAt(Q+1)===r0,J=Q+1;for(;J<V;){var X=$.charCodeAt(J);if(X===m0){J++;break}if(X===z0)return null;X===_0&&J+1<V&&J++,J++}if(J>V||$.charCodeAt(J-1)!==m0)return null;let K=$.slice(Q+1,J-1);if(K.length>999)return null;let G=O$(K);if(!G||J>=V||$.charCodeAt(J)!==x0)return null;J++;let F=!1;for(;J<V;){let x=$.charCodeAt(J);if(x===I||x===R)J++;else if(x===T&&!F)F=!0,J++;else break}if(Y){let x=$.indexOf(`
...
`,Y=i($,O)}for(;V.length>0&&V.charCodeAt(V.length-1)===T;)V=V.slice(0,-1);for(;V.length>0&&V.charCodeAt(V.length-1)===T;)V=V.slice(0,-1);return V?{node:{type:A.codeBlock,text:V},end:Y}:null}function yZ($,Q,Z,V){let Y=G0($,Q);if(N0($,Q,Y),K0>3)return null;let J=Q+V0;if($.charCodeAt(J)!==p)return null;let X="",K=Q,G,F=!1,W=!1,z=!1;for(;K<$.length;){let f=G0($,K);N0($,K,f);let v0=K+V0;if($.charCodeAt(v0)===p){let w=v0+1;var H=K0+1,O=!1;if(w<f){var D=$.charCodeAt(w);D===I?(w++,H++,O=!0):D===R&&(O=!0)}for(var q="",U=!1,B=w;B<f;B++)if($.charCodeAt(B)===R){U=!0;break}if(U){var j=H;if(O&&w<f&&$.charCodeAt(w)===R){for(var v=4-j%4,y=0;y<v-1;y++)q+=" ";j+=v,w++}for(var N=w;N<f;N++)if($.charCodeAt(N)===R){for(var M=4-j%4,L=0;L<M;L++)q+=" ";j+=M}else q+=$[N],j++}else q=$.slice(w,f);if(!X&&!G){let g=q.match(/^\[!([A-Za-z]+)\]\s*$/);if(g){G=g[1].toUpperCase(),K=i($,f);continue}}X+=q+`
`;var k=q.trimStart();k.startsWith("```")||k.startsWith("~~~")?z=!z:q.startsWith("    ")||q.startsWith("	")?z=!0:k.length>0&&!z&&(z=!1),W=k.length>0,K=i($,f)}else if(X&&!$9($,K,f)&&W){if(K0<4){var b=K+V0,P=b<f?$.charCodeAt(b):0;if(P===J9||P===p||P===Q0||P===b0||P===X0||(P===d||P===D0||P===B0)&&R9($,K)||(P===d||P===D0||P===H9)&&b+1<f&&($.charCodeAt(b+1)===I||$.charCodeAt(b+1)===R))break;if(P>=e&&P<=$0){for(var S=b;S<f&&$.charCodeAt(S)>=e&&$.charCodeAt(S)<=$0;)S++;if(S<f&&($.charCodeAt(S)===s0||$.charCodeAt(S)===e0))break}}if(z)break;X+=$.slice(K,f)+`
`,F=!0,K=i($,f)}else break}if(!X&&!G)return null;var{inBlockQuote:E,f:x}=Z;Z.inBlockQuote=!0,F&&(Z.f=!0);let C=A9(X||"",Z,V);Z.inBlockQuote=E,Z.f=x;let m={type:A.blockQuote,children:C};return G&&(m.alert=G),{node:m,end:K}}function x6($,Q,Z){for(var V=0,Y=Q;Y<Z;Y++)$.charCodeAt(Y)===R?V+=4-V%4:V++;return V}function w9($,Q,Z){if(N0($,Q,Z),K0>3)return null;var V=Q+V0;if(V>=Z)return null;var Y=$.charCodeAt(V),J=K0,X=V;if(Y===d||Y===D0||Y===H9){if(X=V+1,X<Z&&$.charCodeAt(X)!==I&&$.charCodeAt(X)!==R&&$.charCodeAt(X)!==T)return null}else if(Y>=e&&Y<=$0){for(var K=V;K<Z&&K-V<9;){var G=$.charCodeAt(K);if(G<e||G>$0)break;K++}if(K>V&&K<Z){var F=$.charCodeAt(K);if(F===s0||F===e0){if(X=K+1,X<Z&&$.charCodeAt(X)!==I&&$.charCodeAt(X)!==R&&$.charCodeAt(X)!==T)return null}else return null}else return null}else return null;var W=X,z=x6($,Q,X),H=0,O=W,D=z;if(W>=Z)return{ordered:Y>=e&&Y<=$0,marker:Y>=e&&Y<=$0?$[K]:$[V],start:Y>=e&&Y<=$0?parseInt($.slice(V,K),10):void 0,contentStart:W,contentCol:z+1,markerCol:J,isEmpty:!0};for(;O<Z&&($.charCodeAt(O)===I||$.charCodeAt(O)===R);){if($.charCodeAt(O)===R){var q=4-D%4;D+=q}else D++;O++,H++}var U=O>=Z,B=D-z;return U||B>4?(D=z+1,O=W+1,H=1):H===0&&(D=z+1,O=W,H=1),{ordered:Y>=e&&Y<=$0,marker:Y>=e&&Y<=$0?$[K]:$[V],start:Y>=e&&Y<=$0?parseInt($.slice(V,K),10):void 0,contentStart:O,contentCol:D,markerCol:J,isEmpty:U}}var H$=0;function LZ($,Q,Z,V){var Y=0,J=Q;for(H$=0;J<Z&&Y<V;){var X=$.charCodeAt(J);if(X===R){var K=4-Y%4;if(Y+K>V){H$=Y+K-V,J++,Y=V;break}Y+=K}else if(X===I)Y++;else break;J++}return J}function M6($,Q,Z,V){var Y=G0($,Q),J=w9($,Q,Y);if(!J)return null;var X=[],K=Q,G=J.contentCol,F="",W=J.isEmpty,z=!1,H=!1;if(!J.isEmpty){for(var O=!1,D=J.contentStart;D<Y;D++)if($.charCodeAt(D)===R){O=!0;break}if(O){var q="",U=x6($,Q,J.contentStart),B=U-J.contentCol;if(B>0)for(var j=0;j<B;j++)q+=" ";for(var v=J.contentStart;v<Y;v++)if($.charCodeAt(v)===R){for(var y=4-U%4,N=0;N<y;N++)q+=" ";U+=y}else q+=$[v],U++;F=q+`
`}else F=$.slice(J.contentStart,Y)+`
`}for(K=i($,Y);K<$.length;){var M=G0($,K);N0($,K,M);var L=$.charCodeAt(K+V0);if(K0<G&&(L===d||L===D0||L===B0)&&K0<=3&&R9($,K))break;var k=w9($,K,M);if(k&&k.ordered===J.ordered&&k.marker===J.marker&&k.markerCol<G){X.push({contentCol:G,raw:F,hasBlankAfter:z,isEmpty:W}),z&&(H=!0),G=k.contentCol,W=k.isEmpty,z=!1,F=k.isEmpty?"":$.slice(k.contentStart,M)+`
`,K=i($,M);continue}if($9($,K,M)){F+=`
`,K=i($,M);for(var b=!1,P=0;P<F.length;P++){var S=F.charCodeAt(P);if(S!==T&&S!==q9&&S!==I&&S!==R){b=!0;break}}if(W&&!b)if(K<$.length){var E=G0($,K),x=w9($,K,E);if(!x||x.ordered!==J.ordered||x.marker!==J.marker)break;z=!0}else break;if(K<$.length){var C=G0($,K);N0($,K,C);var m=$.charCodeAt(K+V0);if((m===d||m===D0||m===B0)&&K0<=3&&R9($,K))break;var f=w9($,K,C);if(f&&f.ordered===J.ordered&&f.marker===J.marker&&f.markerCol<G){z=!0;continue}if(!$9($,K,C)&&K0<G)break}continue}if(K0>=G){var v0=LZ($,K,M,G);if(H$>0){for(var w="",g=G,c=0;c<H$;c++)w+=" ",g++;for(var F0=v0;F0<M;F0++)if($.charCodeAt(F0)===R){for(var P0=4-g%4,Z0=0;Z0<P0;Z0++)w+=" ";g+=P0}else w+=$[F0],g++;F+=w+`
`}else F+=$.slice(v0,M)+`
`;K=i($,M);continue}for(var O0=!1,h=0;h<F.length;h++){var a=F.charCodeAt(h);if(a!==T&&a!==q9&&a!==I&&a!==R){O0=!0;break}}if(!z&&O0&&!W){var M0=K+V0,J0=$.charCodeAt(M0),n=J0===J9||J0===p||J0===X0||J0===Q0||J0===b0||(J0===d||J0===D0||J0===B0||J0===H9)&&(R9($,K)!==null||w9($,K,M)!==null)||J0>=e&&J0<=$0&&w9($,K,M)!==null;if(!n){F+=""+$.slice(M0,M)+`
...
`,n),_=w0<0?H0:w0);if(n>=H0)break;$.charCodeAt(n),N0($,n,_);let t=null;if($.charCodeAt(n)!==l9&&K0>=4&&!Q.inHTML)t=RZ($,n);else if($.charCodeAt(n)!==l9){let k0=n+V0,o=$.charCodeAt(k0);o===J9?t=g6($,n,Q,Z):o===p?t=yZ($,n,Q,Z):o===Q0||o===b0?t=wZ($,n,Q):o===d||o===D0||o===B0?(t=R9($,n),!t&&(t=M6($,n,Q,Z))):o===H9||o>=e&&o<=$0?t=M6($,n,Q,Z):o===X0?t=T6($,n,Q,Z):o===R0?t=v6($,n,Q,Z):o===z0&&(t=EZ($,n,Q))}if(!t){for(var u=!1,W0=n;W0<_;W0++)if($.charCodeAt(W0)===R0){u=!0;break}u&&(t=v6($,n,Q,Z))}if(t||(t=xZ($,n,Q,Z)),t)t.node.type!==A.refCollection&&J0.push(t.node),n=t.end;else{var L0=$.indexOf(`
`,n);n=L0<0?H0:L0+1}}return Q.g=V,J0}function aZ($,Q){i9=0,$.charCodeAt(0)===65279&&($=$.slice(1)),$=x$($);let Z={inline:!1,inAnchor:!1,inHTML:!1,inList:!1,inBlockQuote:!1,refs:{}},V={...Q,slugify:Q?.slugify?J=>Q.slugify(J,u0):u0,sanitizer:Q?.sanitizer||x9,tagfilter:Q?.tagfilter!==!1};j$($,Z.refs,V);let Y=A9($,Z,V);return Z.refs&&Object.keys(Z.refs).length>0?[{type:A.refCollection,refs:Z.refs},...Y]:Y}function C6($,Q,Z,V){var Y=j9($,Q);return Y?{tagName:Y.tag,tagLower:Y.tag.toLowerCase(),attrs:Y.rawAttrs,whitespaceBeforeAttrs:Y.whitespaceBeforeAttrs,isSelfClosing:Y.selfClosing,hasSpaceBeforeSlash:Y.hasSpaceBeforeSlash,isClosing:Y.isClosing,hasNewline:Y.whitespaceBeforeAttrs.includes(`
`)||Y.rawAttrs.includes(`
`),endPos:Y.end}:null}function A$($,Q,Z){i9=0,$=x$($),!Q.refs&&(Q.refs={}),j$($,Q.refs,Z);let V=A9($,Q,Z);return Q.refs&&Object.keys(Q.refs).length>0?[{type:A.refCollection,refs:Q.refs},...V]:V}var sZ=/^\n+/,p$;try{p$=a0.createElement("div").$$typeof}catch{p$=Symbol.for("react.transitional.element")}function d$($,Q,Z){var V={$$typeof:p$,type:$,key:Z!=null?""+Z:null,ref:null,props:Q,h:null};return V}var c$=typeof a0.createContext<"u"?a0.createContext(void 0):void 0;function u6($,Q,Z,V,Y,J,X,K){switch($.type){case A.blockQuote:{let q={key:Z.key};return $.alert&&(q.className="markdown-alert-"+J($.alert.toLowerCase(),u0),$.children.unshift({attrs:{},children:[{type:A.text,text:$.alert}],c:!0,type:A.htmlBlock,tag:"header"})),V("blockquote",q,Q($.children,Z))}case A.breakLine:return V("br",{key:Z.key});case A.breakThematic:return V("hr",{key:Z.key});case A.frontmatter:return K.preserveFrontmatter?V("pre",{key:Z.key},$.text):null;case A.codeBlock:let D=$.lang?o9($.lang):"";return V("pre",{key:Z.key},V("code",{...i0($.attrs||{}),className:D?`language-${D} lang-${D}`:""},$.text));case A.codeInline:return V("code",{key:Z.key},$.text);case A.footnoteReference:return V("a",{key:Z.key,href:Y($.target,"a","href")||void 0},V("sup",{key:Z.key},$.text));case A.gfmTask:return V("input",{checked:$.completed,key:Z.key,readOnly:!0,type:"checkbox"});case A.heading:return V(`h${$.level}`,{id:$.id,key:Z.key},Q($.children,Z));case A.htmlBlock:{let q=$;if(K.tagfilter&&f$(q.tag)){var G="";if(q.attrs)for(var F in q.attrs){var W=q.attrs[F];W===!0?G+=" "+F:W!=null&&W!==!1&&(G+=" "+F+'="'+String(W)+'"')}return V("span",{key:Z.key},"<"+q.tag+G+">")}if(q.a&&q.c){let b=function(w){if((w.type===A.htmlSelfClosing||w.type===A.htmlBlock)&&w.b)return[];if(w.type===A.paragraph){let g=w.children;return g?g.flatMap(b):[]}return w.type===A.text?w.text?.trim()?[w]:[]:w.type===A.htmlBlock&&w.children?[{...w,children:w.children?.flatMap(b)}]:[w]},S=function(w){for(var g=0;g<w.length;g++)w[g].type===A.htmlBlock&&(w[g].c=!1),"children"in w[g]&&w[g].children&&S(w[g].children)},v0=function(w,g){for(var c=0;c<w.length;c++){var F0=w[c];if(F0.type===A.paragraph&&F0.children)for(var P0=F0.children,Z0=0;Z0<P0.length;Z0++){var O0=P0[Z0];if(O0.type===A.htmlSelfClosing&&O0.b&&O0.tag.toLowerCase()===g){var h=w.slice(0,c);Z0>0&&h.push({type:A.paragraph,children:P0.slice(0,Z0)});var a=[];if(Z0+1<P0.length){var M0=P0.slice(Z0+1);M0=M0.filter(function(J0){return!(J0.type===A.htmlSelfClosing&&J0.b)}),M0.length>0&&(a=M0)}return a=a.concat(w.slice(c+1)),{found:!0,beforeClose:h,afterClose:a}}}if((F0.type===A.htmlSelfClosing||F0.type===A.htmlBlock)&&F0.b&&F0.tag.toLowerCase()===g)return{found:!0,beforeClose:w.slice(0,c),afterClose:w.slice(c+1)}}return{found:!1,beforeClose:w,afterClose:[]}},U=q.tag.toLowerCase(),B=R6(U),j=q.children&&q.children.length>0,v=/<[a-z][^>]{0,100}>/i.test(q.a);if(B){let w=q.a.replace(new RegExp("\\s*</"+U+">\\s*$","i"),"");return K.tagfilter&&(w=T$(w)),v?V($.tag,{key:Z.key,...i0($.attrs||{}),dangerouslySetInnerHTML:{__html:w}}):V($.tag,{key:Z.key,...i0($.attrs||{})},w)}let y=new RegExp(`^<${q.tag}(\\s|>)`,"i").test(q.a);if(j&&!y&&K.tagfilter&&O6(q.a))return V($.tag,{key:Z.key,...i0($.attrs||{})},Q(q.children,Z));if(y6(q.a)){let w=K.tagfilter?T$(q.a):q.a;return V($.tag,{key:Z.key,...i0($.attrs||{}),dangerouslySetInnerHTML:{__html:w}})}let M={slugify:w=>J(w,u0),sanitizer:Y,tagfilter:!0},L=q.a.replace(/>\s+</g,"><").replace(/\n+/g," ").trim();if(new RegExp(`^<${q.tag}(\\s[^>]*)?>(\\s*</${q.tag}>)?$`,"i").test(L))return q.children&&q.children.length>0?V($.tag,{key:Z.key,...i0($.attrs||{})},Q(q.children,Z)):V($.tag,{key:Z.key,...i0($.attrs||{})});let P=A$(L,{inline:!1,refs:X,inHTML:!1},M);S(P);let E=q.tag.toLowerCase(),x="</"+E+">",C=new RegExp(`^<${q.tag}(\\s|>)`,"i").test(L),m=L.toLowerCase().trimEnd().endsWith(x),f=C&&m;if(f&&j)return V($.tag,{key:Z.key,...i0($.attrs||{})},Q(q.children,Z));if(f)return Q(P.flatMap(b),Z);var z=v0(P,E);if(z.found&&z.afterClose.length>0){var H=z.beforeClose.flatMap(b),O=z.afterClose.flatMap(b);return d$(a0.Fragment,{children:[V($.tag,{key:Z.key,...i0($.attrs||{})},Q(H,Z)),Q(O,Z)]},null)}return V($.tag,{key:Z.key,...i0($.attrs||{})},Q(P.flatMap(b),Z))}return f9($.tag)?V($.tag,{key:Z.key,...i0($.attrs||{})}):V($.tag,{key:Z.key,...i0($.attrs||{})},$.children?Q($.children,Z):"")}case A.htmlSelfClosing:{let q=$;if(K.tagfilter&&f$(q.tag)){var G="";if(q.attrs)for(var F in q.attrs){var W=q.attrs[F];W===!0?G+=" "+F:W!=null&&W!==!1&&(G+=" "+F+'="'+String(W)+'"')}return V("span",{key:Z.key},"<"+q.tag+G+" />")}return V($.tag,{key:Z.key,...i0($.attrs||{})})}case A.image:{let q=$.target!=null?Y($.target,"img","src"):null;return V("img",{key:Z.key,alt:$.alt&&$.alt.length>0?$.alt:void 0,title:$.title||void 0,src:q||void 0})}case A.link:{let q={key:Z.key};return $.target!=null&&(q.href=z6($.target)),$.title&&(q.title=$.title),V("a",q,Q($.children,Z))}case A.table:{let q=$;return V("table",{key:Z.key},V("thead",null,V("tr",null,q.header.map(function(B,j){return V("th",{key:j,style:q.align[j]==null?{}:{textAlign:q.align[j]}},Q(B,Z))}))),V("tbody",null,q.cells.map(function(B,j){return V("tr",{key:j},B.map(function(y,N){return V("td",{key:N,style:q.align[N]==null?{}:{textAlign:q.align[N]}},Q(y,Z))}))})))}case A.text:return $.text;case A.textFormatted:return V($.tag,{key:Z.key},Q($.children,Z));case A.orderedList:case A.unorderedList:{let q=$.type===A.orderedList?"ol":"ul";return V(q,{key:Z.key,start:$.type===A.orderedList?$.start:void 0},$.items.map(function(B,j){return V("li",{key:j},Q(B,Z))}))}case A.paragraph:return V("p",{key:Z.key},Q($.children,Z));case A.ref:return null;default:return null}}var tZ=($,Q,Z,V,Y,J)=>{var X=G=>G.map(function(F){return"text"in F?F.text:""}),K=(G,F={})=>{var W=(F.renderDepth||0)+1;if(W>2500)return X(G);F.renderDepth=W;for(var z=F.key,H=[],O=!1,D=0;D<G.length;D++){F.key=D;var q;if($){var U=u6.bind(null,G[D],K,F,Q,Z,V,Y,J);q=$(U,G[D],K,F)}else q=u6(G[D],K,F,Q,Z,V,Y,J);var B=typeof q=="string";if(B&&O)H[H.length-1]+=q;else if(q!==null)if(Array.isArray(q))for(var j=0;j<q.length;j++)H.push(q[j]);else H.push(q);O=B}return F.key=z,F.renderDepth=W-1,H};return K},eZ=($,Q)=>{let Z=r9(Q,$,void 0);return Z?typeof Z=="function"||typeof Z=="object"&&"render"in Z?Z:r9(Q,`${$}.component`,$):$};function $5($,Q){let Z={...Q||{}};Z.overrides=Z.overrides||{};let V=Z.slugify||u0,Y=Z.sanitizer||x9,J=Z.createElement,X=Z.overrides&&Object.keys(Z.overrides).length>0,K=B=>l$(B,{...Z,wrapper:null});function G(B,j,...v){var y=j||{};for(var N in y){var M=y[N];if(typeof M=="string"&&M.length>0&&M.charCodeAt(0)===X0&&(b6.test(M)||P6.test(M)||C6(M,0))){var L=K(M.trim());y[N]=N==="innerHTML"&&Array.isArray(L)?L[0]:L}}var k=B;if(X){var b=r9(Z.overrides,B+".props",{});k=eZ(B,Z.overrides),y={...y,...b,className:U6(y.className,b.className)||void 0}}if(!J){var P=y.key;return P!=null&&delete y.key,v.length===1?y.children=v[0]:v.length>1&&(y.children=v),d$(k,y,P)}return J(k,y,...v)}let F={...Z,slugify:B=>V(B,u0),sanitizer:Y,tagfilter:Z.tagfilter!==!1},W=$[0]&&$[0].type===A.refCollection?$[0].refs:{},z=tZ(Z.renderRule,G,Y,V,W,Z),H=z($,{inline:Z.forceInline,refs:W}),O=[];for(let B in W)B.charCodeAt(0)===r0&&O.push({identifier:B,footnote:W[B].target});if(O.length&&H.push(G("footer",{key:"footer"},O.map(function(j){let v=j.identifier.charCodeAt(0)===r0?j.identifier.slice(1):j.identifier,y=A$(j.footnote,{inline:!0,refs:W},F);return G("div",{id:V(v,u0),key:j.identifier},v+": ",z(y,{inline:!0,refs:W}))}))),Z.wrapper===null)return H;let D=Z.wrapper||(Z.forceInline?"span":"div"),q;if(H.length>1||Z.forceWrapper)q=H;else return H.length===1?H[0]:null;var U=Z.wrapperProps?{...Z.wrapperProps}:{};return U.children=q,d$(D,U,"outer")}function l$($="",Q={}){let Z={...Q||{}};Z.overrides=Z.overrides||{};let V=Z.slugify||u0,Y=Z.sanitizer||x9;function J(G){let F=Z.forceInline||!Z.forceBlock&&!q6.test(G),W={...Z,slugify:O=>V(O,u0),sanitizer:Y,tagfilter:Z.tagfilter!==!1};F||j$(G,X,W);let z=G;if(!F){let O=z.length;for(;O>0&&(z[O-1]===`
`||z[O-1]==="\r");)O--;z=z.slice(0,O),z=`${z.replace(sZ,"")}

`}if(Z.optimizeForStreaming){let O=z.lastIndexOf("<");O!==-1&&z.slice(O).indexOf(">")===-1&&(z=z.slice(0,O))}let H=A$(F?G:z,{inline:F,refs:X},W);return $5(H,{...W,forceInline:F})}let X={};return J($)}var O5=({options:$,children:Q})=>c$?a0.createElement(c$.Provider,{value:$},Q):Q,Z5=({children:$,options:Q,...Z})=>{if(!(typeof a0.useContext<"u")){let G={...Q,overrides:{...Q?.overrides},wrapperProps:{...Q?.wrapperProps,...Z}};return l$($??"",G)}let Y=a0.useContext(c$),J=a0.useMemo(()=>({...Y,...Q,overrides:{...Y?.overrides,...Q?.overrides},wrapperProps:{...Y?.wrapperProps,...Q?.wrapperProps,...Z}}),[Y,Q,Z]),X=$??"";return a0.useMemo(()=>l$(X,J),[X,J])},M5=Z5;export{u0 as slugify,x9 as sanitizer,aZ as parser,M5 as default,l$ as compiler,$5 as astToJSX,A as RuleType,O5 as MarkdownProvider,c$ as MarkdownContext,Z5 as Markdown};
